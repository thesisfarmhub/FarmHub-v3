...
$('document').ready(function () {
    ...
    var suitablePurchaseOffer = $("#purchaseOfferDetailsTbl");
    ...
    purchaseOfferBySaleOffer.on('click', 'button[role="rejectBtn"]', function () {
                ...
                Confirm: {
                    ...
                    action: function () {
                        $.ajax({
                            ...
                            type: "POST",
                            url: "/FarmerOfferDetail/RejectOffer?transactionId=" + transactionId,
                            contentType: "application/json; charset=utf-8",
                            method: 'POST',
                            datatype: "text",
                            serverSide: true,
    ...
    suitablePurchaseOfferTbl.on('click', 'button[role="orderBtn"]', function () {
        var id = suitablePurchaseOfferTbl.row($(this).closest('tr')[0]).data()['id'];
        alert(id);
