...
namespace FarmHub.Areas.Farmer.Controllers
{
    public class FarmerOrderController : Controller
    {
        ...
        public ActionResult FarmerOrderIndex(int purchaseOfferId)
        {
            ...
            farmerOrder.productDetailId = GetProducDetail(productId, seedId).Id_ProductDetail;
        ...
        public PRODUCT_DETAIL GetProducDetail(int? productId, int? seedId)
        {
        ...
        [HttpPost]
        public ActionResult CreateOffer(CreateOrderDTO createOrderDTO,  string counterOffered)
        {

            var dao = new FarmerOrderDao();
            dao.Insert(createOrderDTO,  counterOffered);
